      ...
      <div className="grid grid-cols-2 text-white w-full ">
        <div className="w-full px-10">
          <div className="pb-5 border-b-2 text-4xl font-bold">
            {title && keyMovie && keyMovie.length !== 0 && (
              <p>{keyMovie[0].title}</p>
            )}
            {title && keyMovie && keyMovie.length === 0 && <p>{title}</p>}
            {name && keyMovie && keyMovie.length !== 0 && (
              <p>{keyMovie[0].name}</p>
            )}
            {name && keyMovie && keyMovie.length === 0 && <p>{name}</p>}
          </div>
